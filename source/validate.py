...
def main():
    ...
    # Usamos los nombres de archivo que has subido
    ...
    results = [
        ...
        val_series(path_desempleo, {"altas", "altas_montevideo","altas_interior"}),
        val_series(path_recaudacion, {"recaudacion_privados","recaudacion_publicos","recaudacion_total"})
    ]
